...
const FAQ = () => {
  ...
  `,
    ...
    {
      title: `Should I provide employment reference letter for my CDR?
  `,
  ...
  `,
      details: `Yes, it is essential to provide evidence for the English language test while applying for the CDR migration skill assessment.`,
    },
    {
  ...
  `,
    ...
    {
      title: `For How long is your service Valid?
  `,
      details: `Our service is valid for no more than three years.`,
    },
    {
      title: `What if I have to cancel the service? Do you have any refund policy?
  `,
      details: `Sorry, there is no such policy once you agree to pay for our service.`,
    },
    {
      title: `Do I need to have some work experience while applying for CDR?
  `,
      ...
      <Container>
        ...
        >
          ...
          <div className="px-5 py-3">
            <Paragraphs
              data="We’ve share some of our most frequently asked questions to help you out! You can also use the search 
bar for questions which are  not displayed!"
          ...
          <div>
            <img
              src="/images/faq/text.png"
              alt="faq"
              className="img-fluid"
              style={{ height: "200px", width: "235px" }}
            />
            <h5 style={{ color: "#373737", fontWeight: "700" }}>
